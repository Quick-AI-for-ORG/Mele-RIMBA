	...
	\begin{table}[H]
		...
		\resizebox{0.5\columnwidth}{!}{%
			...
			\begin{tabular}{|l|c|c|c|}
				\hline
				\textbf{Model}  & \textbf{MASE} & \textbf{RMSE} & \textbf{MAPE} \\ \hline
				ARIMA  & 0.3563 & 0.3613 & 0.0252  \\ \hline
				Naive Forecaster  & 0.4564 & 0.4656 & 0.0312 \\ \hline
				Theta Forecaster  & 1.0784 & 1.0954 & 0.0762 \\ \hline
				Grand Means Forecaster & 2.1202 & 2.1520 & 0.1620
				\\ \hline
			\end{tabular}%
		}
	\end{table}
	...
	\begin{table}[H]
		...
		\centering
			...
			\begin{tabular}{|l|c|c|c|}
				\hline
				\textbf{Model}  & \textbf{MASE} & \textbf{RMSE} & \textbf{MAPE} \\ \hline
				ARIMA  & 0.6027 & 0.4094 & 0.0068  \\ \hline
				Naive Forecaster  & 0.9252 & 0.6462 & 0.0107 \\ \hline
				Theta Forecaster  & 0.7621 & 0.5180 & 0.0086 \\ \hline
				Grand Means Forecaster & 0.6886 & 0.4673 & 0.0077
				\\ \hline
			\end{tabular}%
		}
	\end{table}
